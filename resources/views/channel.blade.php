...
<div class="card">
  ...
  <img src="{{asset($d->user->avatar)}}" width="55px" height="55px" alt="avatar image">&nbsp;&nbsp;
 ...
 @else
  ...
  @endif
  <a href="{{route('discuss',['slug'=>$d->slug])}}" class="btn btn-outline-info btn-sm float-right">watch</a>
</div>
<div class="card-body">
